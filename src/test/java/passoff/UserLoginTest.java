...
public class UserLoginTest {
    ...
    public void loginUserPass() throws DataAccessException {
        ...
        registerRequest = new RegisterRequest("newUser", "password", "user@gmail.com", "us", "er", "male");
        ...
        loginRequest = new LoginRequest("anothernewUser", "password");
    ...
    public void loginUserFail() throws DataAccessException {
        ...
        userLogin = new UserLogin(loginRequest);
        userLoginResponse = userLogin.loginUser();
        assertTrue(userLoginResponse.getMessage().contains("Error"));
