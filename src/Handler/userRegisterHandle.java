    ...
    public void handle(HttpExchange exchange) throws IOException {
        ...
        try {
            if (exchange.getRequestMethod().toLowerCase().equals("post")) {
                ...
                Gson gson = new Gson();
                userRegisterRequest userRequest = gson.fromJson(reqData, userRegisterRequest.class);
                userRegister userReg = new userRegister(userRequest);
                userRegisterResponse response = userReg.getResponse();
                ...
                if (response.isSuccess()){
                    ...
                    responseData =
                            "{ \"authtoken\": \"" + response.getAuthtoken() +"\"," +
                                    ...
                                    "\"personID\":\"" + response.getPersonsID() + "\"," +
                                    "\"success\":\"true\" } ";
